...
LIBS?=GL GLU SDL2 SDL2_image jpeg GLEW physfs sfml-graphics
TEST_LIBS?=
DEBUG_LIBS?=
RELEASE_LIBS?=
...
# Flags
PROJECT_CFLAGS?=
PROJECT_CXXFLAGS?=-Wextra -D_DEBUG -fsanitize=address -DSPDLOG_TRACE_ON -DSPDLOG_DEBUG_ON -DGLM_FORCE_CXX11 -DGLM_FORCE_SWIZZLE
PROJECT_LDFLAGS?=
